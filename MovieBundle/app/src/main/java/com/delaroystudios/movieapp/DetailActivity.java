...
import static com.delaroystudios.movieapp.data.Downloads.saveToSdCard;
import static com.delaroystudios.movieapp.data.Share.shareToExternal;

import com.delaroystudios.movieapp.data.Share;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        buttonDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String t= saveToSdCard(bmap,movieName);
                if(t.equals("success"))
                    Snackbar.make(buttonDownload, "Poster Downloaded",
                            Snackbar.LENGTH_SHORT).show();
            }
        });
